...
export default function TestCases() {
  ...
  useEffect(() => {
    ...
    api
      .get("/testcases", {
        params: { page, limit: 10, projectId: project.id },
      })
      .then((res) => {
  ...
  if (!project) {
    return <p className="text-gray-500">Please select a project to view test cases.</p>;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {loading && <p className="text-gray-500">Loading test cases…</p>}
                ...
                <tr key={tc.id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="p-3">
                    <div className="flex gap-3 justify-center">
                      {canExecuteTests && (
                        <button
                          onClick={() => navigate("/executions", { state: { testCaseId: tc.id } })}
